    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('journal', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='issues', to='aarons_kit_api.journal')),
            ],
        ),
        migrations.CreateModel(
            name='Article',
            fields=[
                ...
                ('authors', models.ManyToManyField(to='aarons_kit_api.author')),
                ('issue', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='articles', to='aarons_kit_api.issue')),
            ],
        ),
    ]
