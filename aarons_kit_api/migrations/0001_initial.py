# Generated by Django 4.0.3 on 2022-05-03 06:56
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Authors',
            fields=[
                ('AuthorID', models.IntegerField(max_length=500, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Categories',
            fields=[
                ('CategoryID', models.IntegerField(max_length=100, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Journals',
            fields=[
                ('JournalID', models.IntegerField(max_length=100, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Publishers',
            fields=[
                ('PublisherID', models.IntegerField(max_length=100, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='SubCategories',
            fields=[
                ('SubCategoryID', models.IntegerField(max_length=100, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('CategoryID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='journals', to='aarons_kit_api.categories')),
                ('JournalID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='categories', to='aarons_kit_api.journals')),
            ],
        ),
        migrations.CreateModel(
            name='Issues',
            fields=[
                ('IssueID', models.IntegerField(max_length=500, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Articles',
            fields=[
                ('ArticleID', models.IntegerField(max_length=500, primary_key=True, serialize=False)),
        ...
        migrations.AddConstraint(
            model_name='journalcategories',
            constraint=models.UniqueConstraint(fields=('JournalID', 'CategoryID'), name='JournalCategory'),
        ),
        migrations.AddConstraint(
